...
function wrap(context::WrapContext, buf, cursor::MacroExpansion; usename="")
    usename == "" && (usename = name(cursor))
    println("Found MacroExpansion")
    println(cursor)
end

function wrap(context::WrapContext, buf, cursor::MacroInstantiation; usename="")
    usename == "" && (usename = name(cursor))
    println("Found MacroInstantiation")
    println(cursor)
end
